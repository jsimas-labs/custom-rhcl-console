"use strict";
(self["webpackChunkcustom_rhcl_console"] = self["webpackChunkcustom_rhcl_console"] || []).push([["exposed-GatewayListPage"],{
...
/***/ "./components/gateways/GatewayListPage.tsx"
/*!*************************************************!*\
  !*** ./components/gateways/GatewayListPage.tsx ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _hooks_useAttachedPolicies__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../hooks/useAttachedPolicies */ "./hooks/useAttachedPolicies.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../models */ "./models/index.ts");
/* harmony import */ var _utils_hostname__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../utils/hostname */ "./utils/hostname.ts");
/* harmony import */ var _utils_status__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../utils/status */ "./utils/status.ts");
/* harmony import */ var _common_StatusLabel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../common/StatusLabel */ "./components/common/StatusLabel.tsx");
/* harmony import */ var _common_HostnameCell__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../common/HostnameCell */ "./components/common/HostnameCell.tsx");
...
/* harmony import */ var _common_FilterToolbar__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../common/FilterToolbar */ "./components/common/FilterToolbar.tsx");
function _array_like_to_array(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
    for(var i = 0, arr2 = new Array(len); i < len; i++)arr2[i] = arr[i];
    return arr2;
...
var GatewayListPage = function GatewayListPage() {
    ...
    var _useResourceWithRBAC = (0,_hooks_useResourceWithRBAC__WEBPACK_IMPORTED_MODULE_8__.useResourceWithRBAC)(_models__WEBPACK_IMPORTED_MODULE_10__.GatewayGVK), gateways = _useResourceWithRBAC.data, loaded = _useResourceWithRBAC.loaded, hasAccess = _useResourceWithRBAC.hasAccess;
    var namespaces = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(function() {
        return _to_consumable_array(new Set((gateways || []).map(function(gw) {
            var _gw_metadata;
            return ((_gw_metadata = gw.metadata) === null || _gw_metadata === void 0 ? void 0 : _gw_metadata.namespace) || '';
        }))).sort();
    }, [
        gateways
    ]);
    var filtered = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(function() {
        ...
        if (selectedNamespace) {
            items = items.filter(function(gw) {
                var _gw_metadata;
                return ((_gw_metadata = gw.metadata) === null || _gw_metadata === void 0 ? void 0 : _gw_metadata.namespace) === selectedNamespace;
            });
        }
        if (searchValue) {
            ...
            items = items.filter(function(gw) {
                var _gw_metadata;
                var name = (((_gw_metadata = gw.metadata) === null || _gw_metadata === void 0 ? void 0 : _gw_metadata.name) || '').toLowerCase();
                var hostnames = (0,_utils_hostname__WEBPACK_IMPORTED_MODULE_11__.getGatewayExternalHostnames)(gw);
        ...
        if (selectedStatuses.length > 0) {
            items = items.filter(function(gw) {
                var _gw_status, _gw_status1;
                var severity = (0,_utils_status__WEBPACK_IMPORTED_MODULE_12__.getWorstConditionSeverity)((_gw_status = gw.status) === null || _gw_status === void 0 ? void 0 : _gw_status.conditions);
                var isProgrammed = (0,_utils_status__WEBPACK_IMPORTED_MODULE_12__.isConditionTrue)((_gw_status1 = gw.status) === null || _gw_status1 === void 0 ? void 0 : _gw_status1.conditions, 'Programmed');
    ...
    if (!loaded) {
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
            ...
            headingLevel: "h1"
        }, t('Gateways'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
            isFilled: true
    ...
    if (!hasAccess) {
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
            ...
            headingLevel: "h1"
        }, t('Gateways'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_EmptyRBACState__WEBPACK_IMPORTED_MODULE_15__["default"], {
            resource: t('Gateways'),
            verb: "list",
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
        ...
        headingLevel: "h1"
    }, t('Gateways'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_FilterToolbar__WEBPACK_IMPORTED_MODULE_16__["default"], {
        ...
        "aria-label": t('Gateways')
    }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Thead, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Tr, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Th, null, t('Name')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Th, null, t('Namespace')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Th, null, t('Gateway class')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Th, null, t('Status')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Th, null, t('Listeners')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Th, null, t('Hostnames')))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Tbody, null, filtered.map(function(gw) {
        var _gw_metadata;
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(GatewayRow, {
            key: (_gw_metadata = gw.metadata) === null || _gw_metadata === void 0 ? void 0 : _gw_metadata.uid,
            gateway: gw
        });
    })))));
};
var GatewayRow = function GatewayRow(param) {
    var gateway = param.gateway;
    var _gateway_metadata, _gateway_metadata1, _gateway_status;
    var ns = ((_gateway_metadata = gateway.metadata) === null || _gateway_metadata === void 0 ? void 0 : _gateway_metadata.namespace) || '';
    var name = ((_gateway_metadata1 = gateway.metadata) === null || _gateway_metadata1 === void 0 ? void 0 : _gateway_metadata1.name) || '';
    var hostnames = (0,_utils_hostname__WEBPACK_IMPORTED_MODULE_11__.getGatewayExternalHostnames)(gateway);
    var policies = (0,_hooks_useAttachedPolicies__WEBPACK_IMPORTED_MODULE_9__.useAttachedPolicies)('Gateway', name, ns).policies;
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Tr, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Td, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_router__WEBPACK_IMPORTED_MODULE_1__.Link, {
        to: "/connectivity-link/gateways/".concat(ns, "/").concat(name)
    }, name)), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Td, null, ns), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Td, null, gateway.spec.gatewayClassName), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Td, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_StatusLabel__WEBPACK_IMPORTED_MODULE_13__["default"], {
        conditions: (_gateway_status = gateway.status) === null || _gateway_status === void 0 ? void 0 : _gateway_status.conditions
    }), policies.length > 0 && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
        style: {
            marginLeft: 8,
            fontSize: '0.85em',
            color: 'var(--pf-t--global--color--nonstatus--blue--default)'
        }
    }, policies.length, " policies")), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Td, null, gateway.spec.listeners.length), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_6__.Td, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_HostnameCell__WEBPACK_IMPORTED_MODULE_14__["default"], {
        hostnames: hostnames
    })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GatewayListPage);
...
//# sourceMappingURL=exposed-GatewayListPage-chunk.js.map