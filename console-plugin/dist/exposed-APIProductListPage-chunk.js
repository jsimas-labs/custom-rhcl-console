"use strict";
(self["webpackChunkcustom_rhcl_console"] = self["webpackChunkcustom_rhcl_console"] || []).push([["exposed-APIProductListPage"],{

/***/ "./components/api-products/APIProductListPage.tsx"
/*!********************************************************!*\
  !*** ./components/api-products/APIProductListPage.tsx ***!
  \********************************************************/
...
/* harmony import */ var _hooks_useResourceWithRBAC__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../hooks/useResourceWithRBAC */ "./hooks/useResourceWithRBAC.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../models */ "./models/index.ts");
/* harmony import */ var _common_EmptyRBACState__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../common/EmptyRBACState */ "./components/common/EmptyRBACState.tsx");
...
var APIProductListPage = function APIProductListPage() {
    ...
    var _React_useState1 = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState([]), 2), selectedStatuses = _React_useState1[0], setSelectedStatuses = _React_useState1[1];
    var _useResourceWithRBAC = (0,_hooks_useResourceWithRBAC__WEBPACK_IMPORTED_MODULE_10__.useResourceWithRBAC)(_models__WEBPACK_IMPORTED_MODULE_11__.APIProductGVK), apiProducts = _useResourceWithRBAC.data, loaded = _useResourceWithRBAC.loaded, hasAccess = _useResourceWithRBAC.hasAccess;
    var filtered = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(function() {
        var items = apiProducts || [];
        if (searchValue) {
            var lower = searchValue.toLowerCase();
            items = items.filter(function(p) {
                var _p_metadata;
                var displayName = (p.spec.displayName || ((_p_metadata = p.metadata) === null || _p_metadata === void 0 ? void 0 : _p_metadata.name) || '').toLowerCase();
                var tags = (p.spec.tags || []).map(function(t) {
                    return t.toLowerCase();
                });
                return displayName.includes(lower) || tags.some(function(tag) {
                    return tag.includes(lower);
                });
            });
        }
        if (selectedStatuses.length > 0) {
            items = items.filter(function(p) {
                var status = p.spec.publishStatus || 'Draft';
    ...
    if (!loaded) {
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
            ...
            headingLevel: "h1"
        }, t('API Products'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
            isFilled: true
    ...
    if (!hasAccess) {
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
            ...
            headingLevel: "h1"
        }, t('API Products'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_EmptyRBACState__WEBPACK_IMPORTED_MODULE_12__["default"], {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, {
        ...
        headingLevel: "h1"
    }, t('API Products'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Page__WEBPACK_IMPORTED_MODULE_2__.PageSection, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_FilterToolbar__WEBPACK_IMPORTED_MODULE_13__["default"], {
    ...
    }), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Table, {
        "aria-label": t('API Products')
    }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Thead, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Tr, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Th, null, t('Display name')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Th, null, t('Version')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Th, null, t('Publish status')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Th, null, t('Approval mode')), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Th, null, t('Tags')))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Tbody, null, filtered.map(function(product) {
        var _product_metadata, _product_metadata1, _product_metadata2;
        var ns = ((_product_metadata = product.metadata) === null || _product_metadata === void 0 ? void 0 : _product_metadata.namespace) || '';
        var name = ((_product_metadata1 = product.metadata) === null || _product_metadata1 === void 0 ? void 0 : _product_metadata1.name) || '';
        var displayName = product.spec.displayName || name;
        var tags = product.spec.tags || [];
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Tr, {
            key: (_product_metadata2 = product.metadata) === null || _product_metadata2 === void 0 ? void 0 : _product_metadata2.uid
        }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Td, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_router__WEBPACK_IMPORTED_MODULE_1__.Link, {
            to: "/connectivity-link/api-products/".concat(ns, "/").concat(name)
        }, displayName)), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Td, null, product.spec.version || '-'), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Td, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Label__WEBPACK_IMPORTED_MODULE_6__.Label, {
            color: product.spec.publishStatus === 'Published' ? 'green' : 'grey'
        }, t(product.spec.publishStatus || 'Draft'))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Td, null, product.spec.approvalMode || 'automatic'), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_table_dist_dynamic_components_Table__WEBPACK_IMPORTED_MODULE_8__.Td, null, tags.length > 0 ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Tooltip__WEBPACK_IMPORTED_MODULE_7__.Tooltip, {
            content: tags.join(', ')
        }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_core_dist_dynamic_components_Label__WEBPACK_IMPORTED_MODULE_6__.Label, {
            color: "blue"
        }, tags.length, " ", t('Tags').toLowerCase())) : '-'));
    })))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (APIProductListPage);
...
//# sourceMappingURL=exposed-APIProductListPage-chunk.js.map