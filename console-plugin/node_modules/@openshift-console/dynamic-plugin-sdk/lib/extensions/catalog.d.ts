...
export type CatalogItemType = Extension<'console.catalog/item-type', {
...
export type CatalogItemTypeMetadata = Extension<'console.catalog/item-type-metadata', {
    /** Type for the catalog item. */
    type: string;
    /** Custom filters specific to the catalog item.  */
    filters?: CatalogItemAttribute[];
...
export type CatalogItemProvider = Extension<'console.catalog/item-provider', {
...
export type CatalogItemFilter = Extension<'console.catalog/item-filter', {
    /** The unique identifier for the catalog this provider contributes to. */
    catalogId: string | string[];
    /** Type ID for the catalog item type. */
    type: string;
...
export type CatalogItemMetadataProvider = Extension<'console.catalog/item-metadata', {
    /** The unique identifier for the catalog this provider contributes to. */
    catalogId: string | string[];
    /** Type ID for the catalog item type. */
    type: string;
    /** A hook which returns a function that will be used to provide metadata to catalog items of a specific type. */
    provider: CodeRef<ExtensionHook<CatalogItemMetadataProviderFunction, CatalogExtensionHookOptions>>;
}>;
/** This extension allows plugins to contribute a set of categories for a specific catalog item type. */
export type CatalogCategoriesProvider = Extension<'console.catalog/categories-provider', {
...
export type SupportedCatalogExtensions = CatalogItemType | CatalogItemTypeMetadata | CatalogItemProvider | CatalogItemFilter | CatalogItemMetadataProvider | CatalogCategoriesProvider;
export declare const isCatalogItemType: (e: Extension) => e is CatalogItemType;
export declare const isCatalogItemTypeMetadata: (e: Extension) => e is CatalogItemTypeMetadata;
export declare const isCatalogItemProvider: (e: Extension) => e is CatalogItemProvider;
export declare const isCatalogItemFilter: (e: Extension) => e is CatalogItemFilter;
export declare const isCatalogItemMetadataProvider: (e: Extension) => e is CatalogItemMetadataProvider;
export declare const isCatalogCategoriesProvider: (e: Extension) => e is CatalogCategoriesProvider;
