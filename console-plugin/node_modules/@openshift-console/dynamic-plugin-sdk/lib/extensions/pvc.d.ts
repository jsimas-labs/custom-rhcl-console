...
export type PVCCreateProp = Extension<'console.pvc/create-prop', {
...
export type PVCAlert = Extension<'console.pvc/alert', {
    /** The alert component. */
...
export type PVCStatus = Extension<'console.pvc/status', {
...
export type PVCDelete = Extension<'console.pvc/delete', {
