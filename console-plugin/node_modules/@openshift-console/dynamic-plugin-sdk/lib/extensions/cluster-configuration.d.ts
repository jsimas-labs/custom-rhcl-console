...
export type ClusterConfigurationGroup = Extension<'console.cluster-configuration/group', {
...
export type ClusterConfigurationItem = Extension<'console.cluster-configuration/item', {
