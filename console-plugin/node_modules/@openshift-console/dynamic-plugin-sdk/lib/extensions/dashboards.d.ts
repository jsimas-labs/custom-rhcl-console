...
import type { K8sResourceCommon, PrometheusResponse, ResourcesObject, StatusGroupMapper, WatchK8sResources, WatchK8sResults, WatchK8sResourceWithProp, WatchK8sResultsObject } from './console-types';
import type { CardSpan, GetOperatorsWithStatuses, K8sActivityProps, OperatorRowProps, PrometheusActivityProps, PrometheusHealthHandler, PrometheusHealthPopupProps, ResourceHealthHandler, URLHealthHandler } from './dashboard-types';
/** Adds a new dashboard tab, placed after the Overview tab. */
export type DashboardsTab = Extension<'console.dashboards/tab', {
...
export type DashboardsCard = Extension<'console.dashboards/card', {
...
export type DashboardsOverviewHealthPrometheusSubsystem = Extension<'console.dashboards/overview/health/prometheus', {
...
export type DashboardsOverviewHealthURLSubsystem<T = any, R extends K8sResourceCommon | K8sResourceCommon[] = K8sResourceCommon | K8sResourceCommon[]> = Extension<'console.dashboards/overview/health/url', {
    /** The display name of the subsystem. */
    title: string;
...
export type DashboardsOverviewHealthResourceSubsystem<T extends ResourcesObject = ResourcesObject> = Extension<'console.dashboards/overview/health/resource', {
    /** The display name of the subsystem. */
    title: string;
...
/** Adds a health subsystem to the status card of Overview dashboard where the source of status is a K8s REST API. */
export type DashboardsOverviewHealthOperator<T extends K8sResourceCommon = K8sResourceCommon> = Extension<'console.dashboards/overview/health/operator', {
...
export type DashboardsInventoryItemGroup = Extension<'console.dashboards/overview/inventory/item/group', {
...
export type DashboardsOverviewInventoryItem<T extends K8sModel = K8sModel, R extends {
    ...
    [key: string]: K8sResourceCommon[];
}> = Extension<'console.dashboards/overview/inventory/item', DashboardsOverviewInventoryItemProperties<T, R> & {}>;
...
export type DashboardsOverviewInventoryItemReplacement<T extends K8sModel = K8sModel, R extends {
    ...
    [key: string]: K8sResourceCommon[];
}> = Extension<'console.dashboards/overview/inventory/item/replacement', DashboardsOverviewInventoryItemProperties<T, R> & {}>;
...
export type DashboardsProjectOverviewInventoryItem<T extends K8sModel = K8sModel, R extends {
    ...
    [key: string]: K8sResourceCommon[];
}> = Extension<'console.dashboards/project/overview/item', DashboardsOverviewInventoryItemProperties<T, R> & {}>;
...
export type DashboardsOverviewResourceActivity<T extends K8sResourceCommon = K8sResourceCommon> = Extension<'console.dashboards/overview/activity/resource', {
    /** The utilization item to be replaced. */
    k8sResource: CodeRef<WatchK8sResourceWithProp & {
        isList: true;
    }>;
...
export type DashboardsOverviewPrometheusActivity = Extension<'console.dashboards/overview/prometheus/activity/resource', {
    /** Queries to watch */
    queries: string[];
    /** Function which determines if the given resource represents the action. If not defined, every resource represents activity. */
