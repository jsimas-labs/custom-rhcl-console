...
export type ActionProvider = Extension<'console.action/provider', {
...
export type ResourceActionProvider = Extension<'console.action/resource-provider', {
...
export type ActionGroup = Extension<'console.action/group', {
...
export type ActionFilter = Extension<'console.action/filter', {
    /** The context ID helps to narrow the scope of contributed actions to a particular area of the application. Ex - topology, helm */
    contextId: string | 'resource';
