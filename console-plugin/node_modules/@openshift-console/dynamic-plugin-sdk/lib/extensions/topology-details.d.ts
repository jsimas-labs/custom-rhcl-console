...
export type DetailsTab = Extension<'console.topology/details/tab', {
...
export type DetailsTabSection = Extension<'console.topology/details/tab-section', {
...
export type DetailsResourceLink = Extension<'console.topology/details/resource-link', {
...
export type DetailsResourceAlert = Extension<'console.topology/details/resource-alert', {
...
export type PodAdapter = Extension<'console.topology/adapter/pod', {
...
export type BuildAdapter = Extension<'console.topology/adapter/build', {
...
export type NetworkAdapter = Extension<'console.topology/adapter/network', {
