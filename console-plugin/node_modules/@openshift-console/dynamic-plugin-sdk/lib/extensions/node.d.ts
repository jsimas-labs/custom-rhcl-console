...
import type { NodeKind, ResourcesObject, WatchK8sResources, WatchK8sResults } from './console-types';
...
export type NodeStatus<T extends ResourcesObject = ResourcesObject> = Extension<'console.node/status', {
