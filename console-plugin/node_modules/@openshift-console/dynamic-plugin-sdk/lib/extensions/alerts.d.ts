...
export type AlertingRulesSourceExtension = Extension<'console.alerts/rules-source', {
...
export type AlertingRuleChartExtension = Extension<'console.alerts/rules-chart', {
