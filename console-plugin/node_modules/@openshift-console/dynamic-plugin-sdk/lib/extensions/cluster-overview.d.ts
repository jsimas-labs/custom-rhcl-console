...
export type ClusterOverviewInventoryItem = Extension<'console.cluster-overview/inventory-item', {
...
export type ClusterOverviewUtilizationItem = Extension<'console.cluster-overview/utilization-item', {
...
export type ClusterOverviewMultilineUtilizationItem = Extension<'console.cluster-overview/multiline-utilization-item', {
    /** The title of the utilization item. */
    title: string;
    /** Prometheus utilization query. */
...
export type CustomOverviewDetailItem = Extension<'console.dashboards/custom/overview/detail/item', {
    /** Details card title */
    title: string;
