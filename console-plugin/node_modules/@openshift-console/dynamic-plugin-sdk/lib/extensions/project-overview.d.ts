...
export type ProjectOverviewInventoryItem = Extension<'console.project-overview/inventory-item', {
...
export type ProjectOverviewUtilizationItem = Extension<'console.project-overview/utilization-item', {
