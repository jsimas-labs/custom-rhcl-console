 ...
 */
export type ResourceDetailsPage = Extension<'console.page/resource/details', ResourcePageProperties & {}>;
/**
 * Adds a new standalone page rendered outside the common Console page layout.
 *
 * Console application uses [React Router v7](https://reactrouter.com/).
 */
export type StandaloneRoutePage = Extension<'console.page/route/standalone', Omit<RoutePageProperties, 'perspective'>>;
