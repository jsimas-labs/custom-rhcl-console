...
import type { Graph, Node, Model, EdgeModel, NodeModel, EventListener, ModelKind, GraphElement, TopologyQuadrant, NodeShape, WithSelectionProps, WithDragNodeProps, WithDndDropProps, WithContextMenuProps, BadgeLocation, NodeStatus, withContextMenu, DragEvent, DragObjectWithType, DragOperationWithType, ConnectorChoice } from '@patternfly/react-topology';
...
import type { K8sResourceCommon, K8sResourceKind, K8sResourceKindReference, NamespaceMetrics, PodRCData, WatchK8sResults } from './console-types';
...
export type ViewComponentFactory = (kind: ModelKind, type: string, view?: TopologyViewType) => ComponentType<{
...
export type CreateConnection = (source: Node, target: Node | Graph) => Promise<ReactElement[] | null>;
...
export type TopologyDecoratorGetter = (element: Node, radius: number, centerX: number, centerY: number) => ReactElement;
...
export type WithEditReviewAccess = (verb: K8sVerb) => (WrappedComponent: ComponentType) => ComponentType<WithEditReviewAccessComponentProps>;
...
export type WithCreateConnector = <P extends WithCreateConnectorProps & ElementProps>(onCreate: CreateConnectorWidgetProps['onCreate'], ConnectorComponent?: CreateConnectorRenderer, contextMenuClass?: string, options?: CreateConnectorOptions) => (WrappedComponent: ComponentType<Partial<P>>) => FC<Omit<P, keyof WithCreateConnectorProps>>;
