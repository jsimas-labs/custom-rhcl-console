import type { ComponentType, ReactNode, ReactText, ReactNodeArray, SetStateAction, Dispatch } from 'react';
...
import type { ICell, OnSelect, SortByDirection, TableGridBreakpoint } from '@patternfly/react-table';
import type { TFunction } from 'i18next';
import type * as monaco from 'monaco-editor/esm/vs/editor/editor.api';
import type { To } from 'react-router';
import type { ExtensionK8sGroupKindModel, K8sModel, K8sVerb, MatchLabels, PrometheusEndpoint, PrometheusLabels, PrometheusValue, ResolvedExtension, Selector } from '../api/common-types';
 ...
 */
export type NormalizeConsoleHeaders = (headers: Record<string, string | string[] | undefined>) => Record<string, string>;
...
export type CodeEditorProps = Omit<BasicCodeEditorProps, 'code' | 'shortcutsPopoverProps'> & CodeEditorToolbarProps & {
...
export type UseDeleteModal = (resource: K8sResourceCommon, redirectTo?: To, message?: JSX.Element, btnText?: ReactNode, deleteAllResources?: () => Promise<K8sResourceKind[]>) => () => void;
...
export type UseUserPreference = <T>(key: string, defaultValue?: T, sync?: boolean) => [T, Dispatch<SetStateAction<T>>, boolean];
