...
import type { CreateConnectionGetter, RelationshipProviderCreate, RelationshipProviderProvides, TopologyApplyDisplayOptions, TopologyDataModelDepicted, TopologyDataModelGetter, TopologyDataModelReconciler, TopologyDecoratorGetter, TopologyDisplayOption, ViewComponentFactory } from './topology-types';
/** Getter for a ViewComponentFactory */
export type TopologyComponentFactory = Extension<'console.topology/component/factory', {
    /** Getter for a ViewComponentFactory */
    getFactory: CodeRef<ViewComponentFactory>;
}>;
/** Getter for the create connector function */
export type TopologyCreateConnector = Extension<'console.topology/create/connector', {
    /** Getter for the create connector function */
    getCreateConnector: CodeRef<CreateConnectionGetter>;
}>;
/** Topology Data Model Factory Extension */
export type TopologyDataModelFactory = Extension<'console.topology/data/factory', {
...
export type TopologyDisplayFilters = Extension<'console.topology/display/filters', {
...
export type TopologyDecoratorProvider = Extension<'console.topology/decorator/provider', {
...
export type TopologyRelationshipProvider = Extension<'console.topology/relationship/provider', {
