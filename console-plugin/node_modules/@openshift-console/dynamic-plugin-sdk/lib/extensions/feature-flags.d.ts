...
export type FeatureFlag = Extension<'console.flag', {
...
export type ModelFeatureFlag = Extension<'console.flag/model', {
...
export type FeatureFlagHookProvider = Extension<'console.flag/hookProvider', {
    /** Used to set/unset arbitrary feature flags. */
    handler: CodeRef<FeatureFlagHandler>;
}>;
