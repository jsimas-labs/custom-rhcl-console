...
import type { HealthState, K8sResourceCommon, LIMIT_STATE, PrometheusResponse, QueryParams, StatusGroupMapper, TopConsumerPopoverProps, ColumnLayout, RowProps } from '../extensions/console-types';
 ...
 */
export type ConsoleDataViewTh = DataViewTh | {
...
export type GetDataViewRows<TData, TCustomRowData = any> = (data: RowProps<TData, TCustomRowData>[], columns: ConsoleDataViewColumn<TData>[]) => ConsoleDataViewRow[];
export type ConsoleDataViewProps<TData, TCustomRowData = any, TFilters extends ResourceFilters = ResourceFilters> = {
    label?: string;
    data: TData[];
    loaded: boolean;
    loadError?: unknown;
...
export type GetNameCellProps = (name: string) => CellIsStickyProps & {
    hasRightBorder: true;
    'data-test': string;
};
