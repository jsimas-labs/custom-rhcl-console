 ...
 */
export const consoleFetch = require('@console/shared/src/utils/console-fetch')
    .coFetch;
/**
 * A custom wrapper around `fetch` that adds console-specific headers and allows for retries and timeouts.
 * It also validates the response status code and throws an appropriate error or logs out the user if required.
 ...
 * @throws {@link HttpError} when the response status code indicates an error
 */
export const consoleFetchJSON = require('@console/shared/src/utils/console-fetch')
    .coFetchJSON;
/**
 * A custom wrapper around `fetch` that adds console-specific headers and allows for retries and timeouts.
 * It also validates the response status code and throws an appropriate error or logs out the user if required.
 ...
 * @throws {@link HttpError} when the response status code indicates an error
 */
export const consoleFetchText = require('@console/shared/src/utils/console-fetch')
    .coFetchText;
 ...
 * ```
 */
export const useUserPreference = require('@console/shared/src/hooks/useUserPreference')
    .useUserPreference;
/**
 * @deprecated This hook has been renamed to {@link useUserPreference} for consistency.
 */
export const useUserSettings = useUserPreference;
/**
