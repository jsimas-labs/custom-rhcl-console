exports.default = {
  ...
  "definitions": {
    ...
    "StandaloneRoutePage": {
        ...
        "properties": {
          ...
          "properties": {
            ...
            "path": {
              ...
              "description": "Valid URL path or array of paths. Note that React Router v7 does not use `path-to-regexp`."
            },
            "exact": {
              "type": "boolean",
              "description": "When `true`, the path must match the URL exactly."
            }
          },
          "required": [
            "component",
      ...
      "additionalProperties": {},
      "description": "Adds a new standalone page rendered outside the common Console page layout.\n\nConsole application uses [React Router v7](https://reactrouter.com/)."
    },
    "PVCCreateProp": {
      "type": "object",
      "properties": {
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            ...
            "handler": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "Function which handles the file drop action. Can optionally return a path to navigate to after processing the file. If a path is returned, the Console will navigate to that location using React Router."
            }
          },
          "required": [
            "fileExtensions",
    ...
    "SupportedCatalogExtensions": {
      "anyOf": [
        ...
        {
          "$ref": "#/definitions/CatalogCategoriesProvider"
        }
      ]
    },
    "CatalogItemType": {
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            ...
            "sortFilterGroups": {
              "type": "boolean",
              "description": "Determine if filter groups should be sorted alphabetically. Defaults to true."
            },
            "filters": {
              "type": "array",
              "items": {
    ...
    "CatalogCategoriesProvider": {
      ...
      "properties": {
        "type": {
          "type": "string",
          "const": "console.catalog/categories-provider"
        },
        "properties": {
          "type": "object",
          "properties": {
            "catalogId": {
              "type": "string",
              "description": "The catalog ID the categories are for. If not specified, the categories will be available for all catalogs."
            },
            "type": {
              "type": "string",
              "description": "The catalog item type for these categories. If not specified, the categories will be available for all types."
            },
            "provider": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "A hook that returns categories."
            }
          },
          "required": [
            "provider"
      ...
      "additionalProperties": {},
      "description": "This extension allows plugins to contribute a set of categories for a specific catalog item type."
    },
    ...
    "RoutePage": {
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            "perspective": {
              "type": "string",
              "description": "The perspective to which this page belongs to. If not specified, applies to all perspectives."
            },
            "component": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "The component to be rendered when the route matches."
      ...
      "additionalProperties": {},
      "description": "Adds a new page to the Console router.\n\nConsole application uses [React Router v7](https://reactrouter.com/).\n\nNote that React Router v7 no longer supports passing a string array to the Route `path` prop. Console retains this functionality by rendering multiple Route instances. To ensure the route matches the correct paths, consider using `exact: true` and sorting your Route path values from most specific to least specific.\n\nAlso note that React Router v7 no longer supports Route `exact` prop, i.e. paths are matched as `exact: true` by default. Console retains the original behavior for backwards compatibility. Use `exact: true` unless you want to match more of the URL.\n\nDo not use this extension for resource list and details pages. To add a list or details page for a resource, use the `console.navigation/resource-ns` extension instead."
    },
    "ResourceListPage": {
      "type": "object",
      "properties": {
      ...
      "additionalProperties": {},
      "description": "Adds a new resource list page to Console router."
    },
    ...
    "ResourceDetailsPage": {
      ...
      "additionalProperties": {},
      "description": "Adds a new resource details page to Console router."
    },
    "DashboardsTab": {
      "type": "object",
      "properties": {
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            ...
            "fetch": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "Custom function to fetch data from the URL. If none is specified, default one (`coFetchJson`) will be used. Response is then parsed by `healthHandler`."
            },
            "additionalResource": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "Additional resource which will be fetched and passed to `healthHandler`."
