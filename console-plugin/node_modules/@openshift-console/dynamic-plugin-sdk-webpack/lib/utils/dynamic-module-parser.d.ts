 ...
 */
export declare const getDynamicModuleMap: (basePath: string, dynamicModuleDir?: string, indexModule?: string, resolutionField?: string, tsCompilerOptions?: ts.CompilerOptions) => DynamicModuleMap;
