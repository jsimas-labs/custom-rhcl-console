 ...
 */
const getDynamicModuleMap = (basePath, dynamicModuleDir = 'dist/dynamic', indexModule = 'dist/esm/index.js', resolutionField = 'module', tsCompilerOptions = defaultCompilerOptions) => {
