...
export declare const findWebpackModules: (compilation: Compilation, exposedModules: ConsolePluginBuildMetadata["exposedModules"], pluginBasePath?: string) => {
    [moduleName: string]: Module;
};
export declare class ExtensionValidator extends BaseValidator {
    validate(compilation: Compilation, extensions: Extension[], exposedModules: ConsolePluginBuildMetadata['exposedModules'], pluginBasePath?: string): import("./ValidationResult").ValidationResult;
}
export {};
