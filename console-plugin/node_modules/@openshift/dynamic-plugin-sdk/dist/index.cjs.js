...
var cloneDeepWith__default = /*#__PURE__*/_interopDefaultLegacy(cloneDeepWith);
 ...
 */
const cloneDeepOnlyCloneableValues = (obj) => cloneDeepWith__default["default"](obj, (value) => {
...
class PluginLoader {
    ...
    async loadPlugin(manifest) {
        ...
        const pluginBuildHash = isRemoteManifest ? manifest.buildHash ?? uuid.v4() : uuid.v4();
    ...
    resolvePluginDependencies(manifest) {
        return new Promise((resolve, reject) => {
            ...
            let listener;
            const allResolvableDependencies = pickBy__default["default"]({ ...optionalDependencies, ...requiredDependencies }, (versionRange, depName) => {
                ...
                return canResolve && semver.validRange(versionRange);
            });
            ...
            const tryResolveDependencies = () => {
                ...
                const customResolutions = pickBy__default["default"](this.options.customDependencyResolutions, (value) => semver.valid(value));
                const resolutionErrors = [];
                ...
                Object.entries(allResolvableDependencies).forEach(([depName, versionRange]) => {
                    if (pluginResolutions.has(depName)) {
                        ...
                        if (!semver.satisfies(version, versionRange, semverRangeOptions)) {
...
const PluginStoreContext = react.createContext(undefined);
/**
 * React Context provider for passing the {@link PluginStore} down the component tree.
 */
const PluginStoreProvider = ({ store, children }) => (jsxRuntime.jsx(PluginStoreContext.Provider, Object.assign({ value: store }, { children: children }), void 0));
/**
...
const usePluginSubscription = (eventTypes, getData, isSameData = isSameReference) => {
    ...
    const isSameDataRef = react.useRef(isSameData);
    isSameDataRef.current = isSameData;
    const [hookResult, setHookResult] = react.useState(() => getData(pluginStore));
    ...
    react.useEffect(() => pluginStore.subscribe(eventTypes, updateResult), [pluginStore, eventTypes, updateResult]);
    return hookResult;
};
...
const useExtensions = (predicate) => {
    ...
    return react.useMemo(() => predicate
...
const useResolvedExtensions = (predicate, options = defaultOptions) => {
    const includeExtensionsWithResolutionErrors = react.useMemo(() => options.includeExtensionsWithResolutionErrors ??
        defaultOptions.includeExtensionsWithResolutionErrors, [options.includeExtensionsWithResolutionErrors]);
    const useExtensionsImpl = react.useMemo(() => options.useExtensionsImpl ?? defaultOptions.useExtensionsImpl, [options.useExtensionsImpl]);
...
const useFeatureFlag = (name) => {
    const getData = react.useCallback((pluginStore) => pluginStore.getFeatureFlags()[name], [name]);
...
exports.cloneDeepOnlyCloneableValues = cloneDeepOnlyCloneableValues;
exports.consoleLogger = consoleLogger;
exports.isCodeRef = isCodeRef;
exports.isEncodedCodeRef = isEncodedCodeRef;
exports.parseEncodedCodeRef = parseEncodedCodeRef;
